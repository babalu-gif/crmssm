...
<script type="text/javascript">
	...
	$(function(){
		...
		window.open("workbench/main/main_toIndex.do","workareaFrame");
		...
		$("#editPwdBtn").click(function (){
			...
			if (newPwd != confirmPwd){
				layer.alert("两次密码不能不一致", {icon:7});
				return;
			}
			if (oldPwd == newPwd){
				layer.alert("原密码不能和新密码一致", {icon:7});
				return;
			}

			$.ajax({
				url:"workbench/user/editPwd.do",
				data:{
		...
		<div class="modal-dialog" role="document" style="width: 70%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button id="editPwdBtn" type="button" class="btn btn-primary" data-dismiss="modal">更新</button>
				</div>
			</div>
		</div>
	</div>
			...
			<ul>
				<li class="dropdown user-dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li><a id="editPwd" href="javascript:void(0)" data-toggle="modal"><span class="glyphicon glyphicon-edit"></span> 修改密码</a></li>
	...
	<div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0px; right: 0px;">
		...
		<div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto;">
			...
			<ul id="no1" class="nav nav-pills nav-stacked">
				<li class="liClass"><a href="workbench/main/main_toIndex.do" target="workareaFrame"><span class="glyphicon glyphicon-home"></span> 工作台</a></li>
